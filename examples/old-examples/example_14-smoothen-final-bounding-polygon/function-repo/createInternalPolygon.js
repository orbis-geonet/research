...
export function createInternalPolygon(place1, place2) {
  ...
  const polygon = [
    intersectionPoint.map(point => ({ x: parseFloat(point.x.toFixed(2)), y: parseFloat(point.y.toFixed(2)) })),
    ...arcPoints1.map(point => ({ x: parseFloat(point.x.toFixed(2)), y: parseFloat(point.y.toFixed(2)) })),
    intersectionPoint.map(point => ({ x: parseFloat(point.x.toFixed(2)), y: parseFloat(point.y.toFixed(2)) })),
    ...arcPoints2.map(point => ({ x: parseFloat(point.x.toFixed(2)), y: parseFloat(point.y.toFixed(2)) })),
  ];
